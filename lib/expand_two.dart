...
class Expand2 extends StatefulWidget {
  @override
  State createState() {
...
class MyHomePageState extends State<Expand2> {
  @override
                            ...
                            child: ExpandablePanel(
                              ...
                              header: Padding(
                                ...
                                child:  Padding(
                                  ...
                                  child: Text(
                                    "عنوان الخطة هنا",style: TextStyle(color: ColorManager.primaryy,fontSize: 21),
                                  ),
                                ),
                              ),
                              collapsed: Padding(
